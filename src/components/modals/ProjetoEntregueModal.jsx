                    ...
                    <div className="pe-header">
                        <div className="pe-header-info">
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginTop: '0.5rem' }}>
                                ...
                                {/* Botão Documentação */}
                                <button
                                    className="pe-doc-button"
                                    onClick={() => {
                                        if (projeto.docs && projeto.docs.trim() !== '') {
                                            window.open(projeto.docs, '_blank');
                                        } else {
                                            setFeedbackModal({ show: true, type: 'warning', message: 'Link de documentação não disponível para este projeto.' });
                                        }
                                    }}
                                    style={{
                                        display: 'flex',
                                        ...
                                        background: projeto.docs && projeto.docs.trim() !== '' ? 'var(--garagem-magenta)' : 'rgba(156, 163, 175, 0.3)',
                                        color: 'white',
                                        border: 'none',
                                        borderRadius: '6px',
                                        fontSize: '0.75rem',
