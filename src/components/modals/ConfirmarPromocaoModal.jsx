...
export default function ConfirmarPromocaoModal({ colaborador, onConfirm, onClose }) {
    const [nomeInput, setNomeInput] = useState('');
    const [fraseInput, setFraseInput] = useState('');
    const [erros, setErros] = useState({});
    const [loading, setLoading] = useState(false);

    const fraseCorreta = 'promover para administrador';
        ...
        <div className="modal-overlay" onClick={onClose}>
            <div className="modal-confirmacao-content" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="modal-body">
                    <p className="modal-confirmacao-aviso">
                        Você está prestes a promover <strong>{colaborador.name}</strong> a administrador.
                        Esta ação dará acesso total à gestão da empresa.
                    </p>
